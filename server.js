...
const DEFAULT_WORD_LIST = [
    "SWPC", "One Platform", "สภาวิชาชีพ", "สังคมสงเคราะห์", "จริยธรรม", "สถาบันการศึกษา",
    "ใบอนุญาต", "ส่งเสริมวิชาชีพ", "สวัสดิการ", "บริการสังคม", "สมาคมนักสังคมสงเคราะห์แห่งประเทศไทย",
    "ควบคุมมาตรฐาน", "การศึกษาต่อเนื่อง", "การช่วยเหลือ", "เครือข่ายวิชาชีพ", "จรรยาบรรณ",
    "นวัตกรรมสังคม", "จรรยาบรรณ", "พัฒนาศักยภาพ", "นักสังคมสงเคราะห์", "นายกสภาวิชาชีพฯ",
    "สร้างโอกาส", "ความยั่งยืน", "จิตอาสา", "องค์กรวิชาชีพ", "สมาชิกสามัญ", "สมาชิกวิสามัญ", "สมาชิกสมทบ", "สมาชิกกิติมศักดิ์", "สภานายกพิเศษ", "2556", "การสอบข้อเขียน", "การสอบสัมภาษณ์", 
    "กันยายน", "กุมภาพันธ์", "มาตรา28", "ภาคทัณฑ์", "พักใช้ใบอนุญาต", "เพิกถอนใบอนุญาต", "มาตรา 29", "32"
];
...
io.on('connection', (socket) => {
    ...
    // [ส่วนเพิ่ม] แอดมินกดหยุดเสียงเอฟเฟกต์ที่กำลังเล่นอยู่ (เผื่อไฟล์เสียงจริงยาวเกินไป) ส่งสัญญาณหยุดไปทุกจอพร้อมกัน (ผู้เล่น/จอกลาง/แอดมินเอง)
    socket.on('admin-stop-sfx', () => {
        io.emit('stop-sfx');
    });
